...
BOT_TOKEN = environ.get('BOT_TOKEN', "8130309702:AAGxDGWIc6kSaWxB3jc232EJxiv82sAxFCI")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/9ZH.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002342503072','-1002411244352').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002179727590') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001937834296')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://botmakers:botmakers@cluster0.ewpk8uj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mbrequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviesxyz_ofcl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mbrequest') # Support Chat Link Without https:// or @
