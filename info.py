...
PICS = (environ.get('PICS', 'https://envs.sh/9lR.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002397381700') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002358414548')).split()]  # For Multiple Id Use One Space Between Each.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AjayFiles')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mbrquest') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/AjayFiles')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "suitable-raccoon-ajay-tech-6fd57a0b.koyeb.app/")
